...
public class MusicPase : MonoBehaviour
{
    ...
    [SerializeField] int windowSize = 10;
    ...
    /// Unityから操作しない内部変数のため、SerializeFirldで宣言しない)
    /// </summary>
    float originalTempo;
    ...
    private void OnBeat(BeatPacket packet)
    {
        ...
        //最初の拍が存在するなら、タイミングよくテンポを刻むとOnJustTimingを発動
    ...
    /// </summary>
    /// <param name="e">テンポが正しく刻まれた際に呼び出される処理</param>
